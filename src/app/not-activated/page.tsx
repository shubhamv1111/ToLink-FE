...
export default function NotActivatedPage() {
  ...
  const dateText = at ? new Date(at).toLocaleString() : null
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <main className="container mx-auto px-4 py-16 flex items-center justify-center">
        <Card className="p-10 backdrop-blur-sm bg-white/80 dark:bg-gray-800/80 shadow-xl border-0 text-center max-w-xl w-full">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">This link is not active yet</h1>
          <p className="text-gray-600 dark:text-gray-300 mb-2">
            The link you tried to open has been scheduled to activate later.
          </p>
          {dateText && (
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
              Scheduled activation: {dateText}
            </p>
          )}
          {code && (
